...
export default class MapsForm extends Component {
  render() {
    return (
      <div className="right">
        {!this.props.connectionError && <Card bg="dark" text="white" style={{ width: '18rem' }}>
        ...
        {this.props.date[0] && !this.props.connectionError && <Card bg="light" style={{ width: '18rem' }}>
        ...
        {this.props.date[4] && !this.props.connectionError && <Card bg="light" style={{ width: '18rem' }}>
